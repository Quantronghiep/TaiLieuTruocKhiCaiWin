...
class CategoryController extends Controller
{
  public function index()
  {
    ...
    $params = [
      'limit' => 2, //giới hạn 5 bản ghi 1 trang
      'query_string' => 'page',
...
//    }
    ...
    $this->content = $this->render('views/categories/index.php', [
      ...
      $this->page_title = "Quản lý danh mục";
  ...
  public function update()
  {
    ...
    if (isset($_POST['submit'])) {
      ...
      if (empty($this->error)) {
        ...
        header("Location: index.php?controller=category&action=index&page=".$_SESSION['page']);
        exit();
      }
    ...
    //lấy nội dung view create.php
    $this->content = $this->render('views/categories/update.php', ['Category.php' => $category]);
    //gọi layout để nhúng nội dung view create vừa lấy đc
    require_once 'views/layouts/main.php';
  }
