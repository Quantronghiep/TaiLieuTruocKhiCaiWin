 ...
 * kiểu mảng
 * - Xem cookie tại Inspect HTML -> Application
 * -> Cookie
 */
//echo "<pre>";
//print_r($_COOKIE);
...
// + Thêm cookie mới, ko thêm phần tử mới như mảng mà cần dùng hàm sau để thêm
// Thời gian sống tính bằng giây, tính từ thời
//gian hiện tại
setcookie('fullname', 'nvmanh', time() + 3600);
