                ...
                <tr>
                    <td>
                        ...
                        <div class="content-product">
                            <a href="chi-tiet-san-pham/<?php echo $product_id?>"
                    ...
                    <td>
                        <!--  cần khéo léo đặt name cho input số lượng, để khi xử lý submit form  $_POST update lại giỏ hàng sẽ đơn giản hơn    -->
