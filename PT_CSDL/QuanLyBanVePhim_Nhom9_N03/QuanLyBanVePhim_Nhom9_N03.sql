														...
														VIEW
														*/
/* Câu1. Tạo view hiện thông tin của các nhân viên của rạp phim có mã là 'RP01'*/
...
/* Câu1 Tạo thủ tục lấy thông tin của vé */.
...
/*Câu1. Hàm đưa ra thông tin  bộ phim của hãng phim, Diễn viên */
...
--Câu1.Viết trigger tính tiền Vé mỗi khi insert , update ở bảng Ve biết :
...
/*Câu4.Thêm HSL vào bảng NV và Tạo Trigger tự động cập nhật HSL nhân viên
...
--Câu5. Xóa phòng chiếu sẽ xóa ghế ngồi
